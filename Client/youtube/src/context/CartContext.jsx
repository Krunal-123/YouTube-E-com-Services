  ...
  const fetchData = async () => {
    try {
      ...
      if (cookies && cookies.token!=undefined) {
        ...
        console.log("Token is undefined. Skipping user data fetch.");
        Navigate("/login")
      }
    } catch (error) {
...
console.log("check");
  return (
    <CartContext.Provider value={{ cartItems, setCartItems, services, setServices, user, setUser, cookies, removeCookie,fav,setFav,open,setOpen,setAdd}}>
      {children}
