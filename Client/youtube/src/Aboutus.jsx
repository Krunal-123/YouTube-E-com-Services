...
function AboutUs() {
  return (
    <div className="about-us-section bg-gray-100">
      {/* Header Section */}
      ...
      <div className="container mx-auto px-5 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">We are a group of passionate professionals committed to delivering excellence. Our team is diverse, creative, and driven by the desire to innovate.</p>
          </div>
          <div className="bg-white shadow-lg p-6 text-center">
            <FaLightbulb size={50} className="mb-4 text-yellow-500 mx-auto" />
            <h2 className="text-2xl font-bold mb-2">Our Mission</h2>
            <p className="text-gray-600">Our mission is to provide high-quality solutions that make life easier and more enjoyable for our customers. We strive to lead the industry with our innovative ideas.</p>
          </div>
          <div className="bg-white shadow-lg p-6 text-center">
            <FaCogs size={50} className="mb-4 text-green-500 mx-auto" />
            <h2 className="text-2xl font-bold mb-2">Our Services</h2>
            <p className="text-gray-600">We offer a range of services that cater to your needs, from consulting to development. We focus on quality, efficiency, and customer satisfaction.</p>
          </div>
        </div>
        ...
        <div className="mb-12">
          <div className="bg-white shadow-lg p-6">
            ...
            <p className="text-gray-700 mb-6">
              Founded in [Year], our company started with a simple idea to innovate and improve the everyday lives of people. Over the years, we have grown into a team of dedicated professionals who are passionate about making a difference. Our story is one of perseverance, creativity, and a relentless commitment to quality.
            </p>
            <div className="text-center">
              <button className="bg-blue-500 text-white py-2 px-4 rounded-lg shadow-md hover:bg-blue-600 transition-all">Learn More</button>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-gray-600">MEAN Developer</p>
        ...
        <div className="mb-12">
          <h2 className="text-4xl font-bold text-center mb-6">Our Milestones</h2>
          <div className="bg-white shadow-lg p-6">
        ...
        <div className="mb-12">
          <h2 className="text-4xl font-bold text-center mb-6">Our Happy Clients😊</h2>
            ...
            {[
              ...
              <div key={index} className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-6 text-center">
                  ...
                  <p className="text-gray-700 font-bold text-xl mb-2">"{client.name}"</p>
        ...
        <Row className="my-5">
          <Col md={12}>
            <h2 className="text-center mb-4 text-4xl font-bold">Frequently Asked Questions</h2>
            <Accordion>
